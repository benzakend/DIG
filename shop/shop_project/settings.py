...
MIDDLEWARE = [
    ...
    'shop_project.middleware.DisableCSRFMiddleware',
...
# Use PostgreSQL in production (DEBUG=False)
if not DEBUG:
    DATABASES = {
        'default': {
            'ENGINE': 'django.db.backends.postgresql',
            'NAME': os.environ.get('POSTGRES_DB', 'shaubi'),
            'USER': os.environ.get('POSTGRES_USER', 'shaubi'),
...
SESSION_COOKIE_HTTPONLY = False  # Allow JS access for frontend
...
# Disable CSRF entirely for development
USE_CSRF = False
